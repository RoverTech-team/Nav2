...
def generate_launch_description():
    ...
    params_file = os.path.join(pkg_share, "config", "nav2_params_zed.yaml")
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                ...
                description="Absolute path to a map YAML. Start with the Stage 1 lidar map.",
            ),
            ...
            Node(
                ...
                output="screen",
                parameters=[os.path.join(pkg_share, "config", "pointcloud_to_laserscan.yaml")],
                remappings=[
                    ("cloud_in", "/zed/points"),
                    ("scan", "/zed/scan"),
                ],
