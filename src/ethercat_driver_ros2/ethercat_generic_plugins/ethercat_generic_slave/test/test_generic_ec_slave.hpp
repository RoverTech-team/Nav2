...
class FriendGenericEcSlave : public ethercat_generic_plugins::GenericEcSlave
{
  ...
  FRIEND_TEST(GenericEcSlaveTest, EcWriteRPDOVelocityCommandInvertedForRightSideJoint);
  FRIEND_TEST(GenericEcSlaveTest, EcWriteRPDOVelocityCommandUnchangedForLeftSideJoint);
  FRIEND_TEST(GenericEcSlaveTest, EcReadTPDOVelocityInvertedForRightSideJoint);
  FRIEND_TEST(GenericEcSlaveTest, EcReadTPDOVelocityUnchangedForLeftSideJoint);
